          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0">
              ...
              <div className="flex flex-col items-center text-center border-slate-800 md:border-r last:border-0 px-4">
                ...
                <span className="text-3xl font-extrabold font-heading">85,000+</span>
        ...
        <section className="py-20 bg-slate-50/50">
          <div className="container mx-auto px-4 max-w-7xl text-center">
            ...
            <TestimonialsCarousel
              testimonials={[
                { id: 1, patient_name: "Ramesh, Pragathi Nagar", text: "I got my dental implants done at Dental World. The experience was excellent and totally painless. Highly recommended!", rating: 5, treatment_name: "Implants" },
                { id: 2, patient_name: "Sunitha, Bachupally", text: "Very professional team and advanced technology. My smile makeover has given me so much confidence!", rating: 5, treatment_name: "Smile Makeover" },
                { id: 3, patient_name: "Karthik, Pragathi Nagar", text: "Best dental clinic in Hyderabad! Friendly staff, clean clinic and amazing results.", rating: 5, treatment_name: "General Dentistry" },
              ]}
            />
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              ...
              <div className="w-full lg:w-[48%] bg-gradient-to-br from-[#0c2340] via-[#0b1c3c] to-[#071329] text-white p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between shadow-xl border border-blue-950/20 hover:shadow-2xl transition duration-300">
                <div className="space-y-6 relative z-10 max-w-[62%] sm:max-w-[58%]">
                ...
                <div className="absolute right-0 top-0 bottom-0 w-[52%] sm:w-[48%] pointer-events-none select-none">
                  ...
                  />
                  <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#0b1c3c] to-transparent"></div>
                </div>
